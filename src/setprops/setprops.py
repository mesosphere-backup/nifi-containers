...
@click.option(
    '--prefix',
    '-p',
    help='What prefix to use. Will also use the value of the CNF_PREFIX environment variable, '
         'if defined. Default prefix is DCNF_',
    required=True,
    default='NF_',
    envvar='CNF_PREFIX'
)
...
def mkiniconf(configfile, prefix, template, templatedir):
